    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-sm-12 col-xs-12 forum" style="margin: auto;">
                <h2 style="text-align: center; background-color: green; padding: 5px;">Quản lí bài viết</h2>
                <a href="{{route('forum.duyet')}}" class="btn btn-success">Bài viết đang chờ</a>
            ...
            <small class="error">@error('image') {{$message}}@enderror</small>
                ...
                <div class="bang_tin text-left">
                    <div class="info">
                        ...
                        <div>
                            <a href="{{route('forum.xoa',$t->id)}}" class="btn btn-danger" onclick="return confirm('Bát nước hất đi không lấy được lại đâu đấy!')">Xóa</a>
                        </div>
                    </div>
                    ...
                    <!-- comment -->
                    <div class="comment">
                        <form action="{{route('comment_ad',$t->id)}}" method="post">
                            @csrf
                            ...
                            <div style="display: flex; justify-content: space-between">
                                ...
                                @endforeach
                                @if($cm==0)
                                <a href="{{route('forum.comment',$t->id)}}">Chưa có lượt bình luận nào!</a>
                                @else
                                <a href="{{route('forum.comment',$t->id)}}">{{$cm}} bình luận</a>
                                @endif
                            </div>
                        </form>
                    </div>
